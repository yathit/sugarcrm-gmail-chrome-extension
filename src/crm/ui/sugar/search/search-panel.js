...
/** @return {string} */
ydn.crm.ui.sugar.SearchPanel.prototype.getCssClass = function() {
  return ydn.crm.ui.sugar.SearchPanel.CSS_CLASS;
};
...
ydn.crm.ui.sugar.SearchPanel.prototype.addResult_ = function(result) {
  ...
  if (n > ydn.crm.ui.sugar.SearchPanel.MAX_PANELS) {
    ...
    m.setResult(result);
    var ch = new ydn.crm.ui.sugar.SearchResult(this.dom_, m, false);
