...
goog.provide('ydn.crm.inj.sugar.GDataModule');
 ...
 * @param {ydn.crm.inj.sugar.model.GDataSugar} parent
 * @param {ydn.crm.sugar.ModuleName} module_name
 * @constructor
 * @extends {ydn.crm.sugar.model.Module}
 * @struct
 */
ydn.crm.inj.sugar.GDataModule = function(parent, module_name) {
...
goog.inherits(ydn.crm.inj.sugar.GDataModule, ydn.crm.sugar.model.Module);


/**
 * @define {boolean} debug flag.
 */
ydn.crm.inj.sugar.GDataModule.DEBUG = goog.DEBUG;
 ...
 */
ydn.crm.inj.sugar.GDataModule.prototype.getParent = function() {
  return /** @type {ydn.crm.inj.sugar.model.GDataSugar} */ (this.parent);
};
 ...
 */
ydn.crm.inj.sugar.GDataModule.prototype.getContactModel = function() {
 ...
 */
ydn.crm.inj.sugar.GDataModule.prototype.getGData = function() {
 ...
 */
ydn.crm.inj.sugar.GDataModule.prototype.getUnboundGData = function() {
 ...
 */
ydn.crm.inj.sugar.GDataModule.prototype.setGData = function(record) {
  // check valid record.
 ...
 * @return {boolean}
 */
ydn.crm.inj.sugar.GDataModule.prototype.isSynced = function() {
 ...
 * @private
 */
ydn.crm.inj.sugar.GDataModule.prototype.handleContactModelChange_ = function(e) {
 ...
 * @private
 */
ydn.crm.inj.sugar.GDataModule.prototype.invalidateContactModel_ = function(contact_model) {
  this.setRecord(null);
  if (!contact_model) {
    return;
  }
 ...
 * @return {boolean}
 */
ydn.crm.inj.sugar.GDataModule.prototype.canImportToSugar = function() {
 ...
 * @return {boolean}
 */
ydn.crm.inj.sugar.GDataModule.prototype.canLink = function() {
  if (this.getGData()) {
 ...
 * @protected
 */
ydn.crm.inj.sugar.GDataModule.prototype.disposeInternal = function() {
...
if (goog.DEBUG) {
   ...
   * @inheritDoc
   */
  ydn.crm.inj.sugar.GDataModule.prototype.toString = function() {
    var s = '';
    if (this.record) {
      s += ':' + this.record;
    }
