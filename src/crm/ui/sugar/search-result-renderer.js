 ...
 * @type {string}
 */
ydn.crm.ui.sugar.SearchResultRenderer.CSS_CLASS = 'search-result sugar-panel';
 ...
 * @type {string}
 */
ydn.crm.ui.sugar.SearchResultRenderer.CSS_CLASS_CONTENT = 'record-body';
...
ydn.crm.ui.sugar.SearchResultRenderer.prototype.updateHeader_ = function(header, record) {
  ...
  var icon = goog.dom.getElementByClass(ydn.crm.ui.sugar.SearchResultRenderer.CSS_CLASS_ICON,
      header);
  title.textContent = record.getRecord().getFullName();
