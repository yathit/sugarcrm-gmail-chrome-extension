...
var ydn = {msg:{}};
ydn.msg.Channel = function(a, b, c) {
  this.main_ = a;
  this.group_ = b;
  this.name_ = c;
...
ydn.msg.Channel.prototype.send = function(a, b) {
  var c = new ydn.msg.Message(a);
  c.setRef(this.group_, this.name_);
  c.setData(b);
  var d = c.promise();
  this.main_.sendMsg(c);
  return d;
};
ydn.msg.Event = function(a) {
  goog.events.Event.call(this, a.req || "event");
  this.mesage = a;
};
...
ydn.time = {};
ydn.base.JQUERY = !1;
goog.log.finest = function(a, b, c) {
  goog.log.ENABLED && a && a.log(goog.debug.Logger.Level.FINEST, b, c);
};
goog.log.finer = function(a, b, c) {
  goog.log.ENABLED && a && a.log(goog.debug.Logger.Level.FINER, b, c);
};
ydn.time.MINUTE = 6E4;
...
ydn.time.getNextNominal = function() {
  var a = new Date, b = a.getFullYear(), c = a.getMonth(), d = a.getDate(), e = a.getHours(), e = 30 < a.getMinutes() ? e + 1 : e + 2;
  return new Date(b, c, d, e);
};
ydn.time.getWeekend = function(a) {
  a = a || new Date;
  var b = (7 - a.getDay()) % 7 + a.getDate();
  return new Date(a.getFullYear(), a.getMonth(), b, 23, 59, 59, 999);
};
ydn.debug = {};
ydn.debug.error = {};
ydn.debug.error.ArgumentException = function(a) {
  goog.debug.Error.call(this, a);
  this.name = "ydn.error.ArgumentException";
};
goog.inherits(ydn.debug.error.ArgumentException, goog.debug.Error);
ydn.debug.error.TypeError = function(a) {
  goog.debug.Error.call(this, a);
  this.name = "ydn.error.TypeError";
};
goog.inherits(ydn.debug.error.TypeError, goog.debug.Error);
ydn.debug.error.NotSupportedException = function(a) {
  goog.debug.Error.call(this, a);
  this.name = "ydn.error.NotSupportedException";
};
goog.inherits(ydn.debug.error.NotSupportedException, goog.debug.Error);
ydn.debug.error.NotImplementedException = function(a) {
  goog.debug.Error.call(this, a);
  this.name = "ydn.error.NotImplementedException";
};
goog.inherits(ydn.debug.error.NotImplementedException, goog.debug.Error);
ydn.debug.error.InvalidOperationException = function(a) {
  goog.debug.Error.call(this, a);
  this.name = "ydn.error.InvalidOperationException";
};
goog.inherits(ydn.debug.error.InvalidOperationException, goog.debug.Error);
ydn.debug.error.InternalError = function(a) {
  Error.captureStackTrace ? Error.captureStackTrace(this, ydn.debug.error.InternalError) : this.stack = Error().stack || "";
  a && (this.message = String(a));
...
ydn.debug.error.ConstraintError = function(a) {
  Error.captureStackTrace ? Error.captureStackTrace(this, ydn.debug.error.ConstraintError) : this.stack = Error().stack || "";
  a && (this.message = String(a));
...
ydn.async = {};
ydn.async.Deferred = function(a, b) {
  goog.async.Deferred.call(this, a, b);
  this.progbacks_ = [];
};
goog.inherits(ydn.async.Deferred, goog.async.Deferred);
ydn.async.Deferred.prototype.addProgback = function(a, b) {
  this.progbacks_.push([a, b]);
  return this;
};
ydn.async.Deferred.prototype.notify = function(a) {
  for (var b = 0;b < this.progbacks_.length;b++) {
    this.progbacks_[b][0].call(this.progbacks_[b][1], a);
  }
};
ydn.async.Deferred.prototype.callback = function(a) {
  this.progbacks_.length = 0;
  ydn.async.Deferred.superClass_.callback.call(this, a);
};
ydn.async.Deferred.prototype.errback = function(a) {
  this.progbacks_.length = 0;
  ydn.async.Deferred.superClass_.errback.call(this, a);
};
ydn.async.Deferred.prototype.chainDeferred = function(a) {
  ydn.async.Deferred.superClass_.chainDeferred.call(this, a);
  a instanceof ydn.async.Deferred && a.addProgback(function(a) {
    this.notify(a);
  }, this);
  return this;
};
...
ydn.msg.Message.prototype.setRef = function(a, b) {
  this.group_ = a;
  this.name_ = b;
};
ydn.msg.Message.counter_ = 0;
ydn.msg.Message.TIMEOUT = 3E4;
...
ydn.msg.Message.prototype.listen = function(a) {
  if (a && a.id == this.id) {
    this.data_ = a.data;
    var b = a.error;
    if (b) {
      if (b instanceof Error) {
        ...
        if (goog.isObject(b)) {
          this.error_ = Error(b.message), b.name && (this.error_.name = b.name), this.error_.source = b, this.error_.result = this.data_;
        } else {
          if (goog.isString(b)) {
            if (goog.json.isValid(b)) {
              try {
                var c = JSON.parse(b);
                this.error_ = Error(c.message);
                for (var d in c) {
                  this.error_[d] = c[d];
                }
              } catch (e) {
    ...
    a.done ? (this.alive_ = !1, this.error_ ? this.df_.errback(this.error_) : this.df_.callback(this.data_), window.clearTimeout(this.tid_)) : this.df_.notify(a.data);
    return !0;
  }
  return !1;
};
...
ydn.msg.Message.prototype.setData = function(a) {
  this.data_ = a;
};
...
ydn.msg.Message.prototype.toJSON = function() {
  ...
  return {id:this.id, req:this.req, group:this.group_, name:this.name_, data:this.data_};
};
ydn.crm = {};
ydn.crm.ch = {};
ydn.crm.ch.Req = {APP_SETTING:"app-setting", ACK:"ack", BADGE_UPDATE:"badge-update", CLOSE:"close", DNT_ADD:"dnt-add", DNT_QUERY:"dnt-query", DNT_REMOVE:"dnt-remove", EXPORT_RECORD:"export-record", ECHO:"echo", FEED_LOG:"feed-log", FEED_LOG_INFO:"feed-log-info", FEEDBACK:"feedback", GAPPS_CAL_SYNC_SET_INFO:"ga-scsi", GAPPS_CAL_SYNC_INFO:"ga-csi", GAPPS_CAL_SYNC_DEL_ALL:"ga-cs-del-all", GAPPS_CAL_SYNC_RE:"ga-cs-re", GAPPS_CAL_SET_SETTING:"ga-cs-ss", GAPPS_CAL_SYNC_NOW:"ga-csn", GAPPS_LIST_CAL:"ga-lc", 
GAPPS_NEW_CAL:"ga-nc", GET_SUGAR:"get-sugar", GDATA_CONTACT_MERGE:"gdata-cm", GDATA_COUNT:"gdata-dc", GDATA_LIST_CONTACT:"gdata-list-contact", GDATA_LIST_GROUP:"gdata-list-group", GDATA_UPDATE:"gdata-update", LIST_SUGAR:"list-sugarcrm", LIST_SUGAR_DOMAIN:"list-sugarcrm-domain", LOG:"log", LOGGING_PREF_ANALYTIC:"lg-pref-qa", LOGGING_PREF_DEBUG:"lg-pref-bg", LOGIN_INFO:"login-info", LOGGED_IN:"logged-in", LOGGED_OUT:"logged-out", LOGIN_SUGAR:"login-su", NEW_ENTRY:"new-entry", NEW_SUGAR:"new-sugarcrm", 
NUKE:"nk", REMOVE_SUGAR:"remove-sugar", REQUEST:"request", REQUEST_HOST_PERMISSION:"request-host-permission", SERVER_AUDIT_LOG:"server-audit-log", SOCIAL_FEED:"social-feed", SOCIAL_PROFILE:"social-profile", SOCIAL_PROFILE_DETAIL:"social-profile-detail", SUGAR_SERVER_INFO:"sugar-server-info", SYNC:"sync", SYNC_FOR:"sync-for", SYNC_GET_LAST:"sync-gl", SYNC_QUERY:"sync-q", TOKEN_GDATA:"token-gdata", TOKEN_REVOKE_GDATA:"token-revoke-gdata", TRACKING_CLEAR_DNT:"tracking-clear-dnt", TRACKING_SELF_OPEN:"tracking-self-open", 
TRACKING_QUERY:"tracking-query", TRACKING_UPDATE:"tracking-update", USER_LICENSE:"user-license", USER_SETTING_SERVER_GET:"us-server-get", USER_SETTING_SERVER_SET:"us-server-set"};
ydn.crm.ch.BReq = {NEW_UPDATE_MESSAGE:"new-up-msg", STATUS_INFO:"st-info", HOST_PERMISSION:"host-permission", SUGARCRM:"sugarcrm", SUGARCRM_CACHE_UPDATE:"sugarcrm-ca-up", SUGARCRM_CACHE_FETCH:"sugarcrm-ca-ft", LOGGED_OUT:"logout", LOGGED_IN:"login", NEW_TRACKING_POINT:"new-tracing-point"};
ydn.crm.ch.SReq = {ABOUT:"about", ACTIVITY_STREAM:"activity-stream", ACTIVITY_UPCOMING:"activity-upcoming", CLEAR_CACHE:"clear-cache", COUNT:"count", DELETE_RECORD:"delete-record", DETAILS:"details", FETCH:"fetch", FETCH_MODULE:"fetch-module", FETCH_UPCOMING_ACTIVITIES:"fetch-up-act", FILTER_IN_SERVER:"se-fis", FIND:"find", GET:"get", GET_FAVORITE_ASYNC:"get-favorite-async", IMPORT_GDATA:"import-gdata", INFO_MODULE:"info-module", KEYS:"keys", LINK:"link", LIST_MODULE:"list-module", LIST_NAME:"list-name", 
LIST_UPCOMING_ASYNC:"list-upcoming-async", LOGIN:"login", LOGIN_USER:"login-user", LOGIN_INFO:"login-info", NEW_RECORD:"new-record", PUT_RECORD:"put-record", QUERY:"query", QUERY_BY_EMAIL_ON_CLIENT:"query-by-email-on-client", QUERY_BY_EMAIL_ON_SERVER:"query-by-email-on-server", QUERY_EMBEDDED:"query-embedded", QUERY_ENTRY:"query-entry", QUERY_RELATED_ASYNC:"query-related-async", QUERY_RELATED:"query-related", QUERY_SIMILAR:"query-similar", REST:"rest", SEARCH:"search", SEARCH_BY_MODULES:"se-bms", 
SEARCH_BY_NAME_IN_SERVER:"se-nms", SERVER_INFO:"server-info", SET_REL:"set-rel", STATS:"stats", UNLINK:"unlink", UPLOAD:"upload", UPDATE_AUDIT:"update-audio", UPDATE_CLEAR:"update-clear", UPDATE_NOW:"update-now", UPDATE_RESET_CHECKPOINT:"update-reset", VALUES:"values"};
ydn.msg.Pipe = function(a) {
  goog.events.EventTarget.call(this);
  var b = goog.isString(a) ? a : a.name;
  a = goog.isString(a) ? null : a;
  this.name = b;
  this.messages_ = [];
  this.info_ = a;
  this.port_ = null;
...
ydn.msg.Pipe.DEBUG = !1;
ydn.msg.RReq = {INFO:"info", HTML_BODY_INNER:"html-body-inner"};
ydn.msg.Pipe.prototype.defaultListener_ = function(a) {
  if (a) {
    if (a.id) {
      for (var b = this.messages_.length - 1;0 <= b;b--) {
        if (ydn.msg.Pipe.DEBUG && window.console.log("handing " + b + " of " + this.messages_.length), this.messages_[b].getId() == a.id) {
          ydn.msg.Pipe.DEBUG && window.console.log(this + " receiving msg " + a.req + ":" + a.id, a);
          if (this.messages_[b].listen(a)) {
            this.messages_[b].hasDone() ? this.messages_.splice(b, 1) : b > ydn.msg.Pipe.MAX_MESSANGERS / 2 && (a = this.messages_.splice(b, 1), this.messages_.unshift(a[0]));
            break;
          }
          break;
        }
      ...
      ydn.msg.Pipe.DEBUG && goog.global.console.log("receiving broadcast " + JSON.stringify(a)), a.req == ydn.msg.RReq.INFO ? (a.data = this.info_, this.port_.postMessage(a)) : a.req == ydn.msg.RReq.HTML_BODY_INNER ? (window.console.log("html", a), a.req = "", a.done = !0, a.data = document && document.body ? document.body.innerHTML : "", this.port_.postMessage(a)) : this.dispatchEvent(new ydn.msg.Event(a));
    }
  }
};
ydn.msg.Pipe.prototype.sendMsg = function(a) {
  var b = a.toJSON();
  ydn.msg.Pipe.DEBUG && window.console.log(this + " sending msg " + b.req + ":" + b.id);
  goog.DEBUG && ydn.msg.Pipe.dry_run_ && 0 <= [ydn.crm.ch.Req.DNT_ADD, ydn.crm.ch.Req.DNT_REMOVE, ydn.crm.ch.Req.EXPORT_RECORD, ydn.crm.ch.Req.FEEDBACK, ydn.crm.ch.Req.GAPPS_NEW_CAL, ydn.crm.ch.Req.GDATA_UPDATE, ydn.crm.ch.Req.NEW_ENTRY, ydn.crm.ch.Req.REMOVE_SUGAR, ydn.crm.ch.Req.SYNC, ydn.crm.ch.Req.SYNC_FOR, ydn.crm.ch.SReq.DELETE_RECORD, ydn.crm.ch.SReq.IMPORT_GDATA, ydn.crm.ch.SReq.LINK, ydn.crm.ch.SReq.SET_REL, ydn.crm.ch.SReq.PUT_RECORD].indexOf(a.getReq()) ? window.console.log("dryRun: " + 
  a.getReq(), a) : (this.getPort().postMessage(b), this.messages_.push(a), this.messages_.length > ydn.msg.Pipe.MAX_MESSANGERS && --this.messages_.length);
};
ydn.msg.Pipe.prototype.getChannelName = function() {
  return this.name;
};
ydn.msg.Pipe.prototype.getChannel = function(a, b) {
  var c = a || ydn.msg.Group.MAIN, d = c + (b ? "-" + b : "");
  this.sub_channels_[d] || (this.sub_channels_[d] = new ydn.msg.Channel(this, c, b || ""));
  return this.sub_channels_[d];
};
ydn.msg.Pipe.prototype.findChannel = function(a, b) {
  for (var c in this.sub_channels_) {
    var d = c.split("-");
    if (a == d[0] && (!b || b == d[1])) {
      return this.sub_channels_[c];
    }
  }
  return null;
};
ydn.msg.Pipe.prototype.getPort = function() {
  if (!this.port_) {
    ...
    var b = goog.bind(this.defaultListener_, this);
    this.port_.onMessage.addListener(b);
    this.port_.onDisconnect.addListener(function() {
      ydn.msg.Pipe.DEBUG && goog.global.console.log("disconnected port " + a.port_.name + " " + a.port_.url);
      a.port_.onMessage.removeListener(b);
      a.port_ = null;
      a.messages_.length = 0;
    });
  }
...
ydn.msg.getMain = function() {
  if (!ydn.msg.main_) {
    var a = ydn.msg.Group.MAIN + "-" + goog.now();
    ydn.msg.main_ = new ydn.msg.Pipe(a);
  }
  return ydn.msg.main_;
};
ydn.msg.initPipe = function(a) {
  goog.asserts.assert(!ydn.msg.main_, "already initialize pipe.");
  var b = a;
  goog.isString(a) && (b = {group:a, name:a + "-" + goog.now()});
  ydn.msg.main_ = new ydn.msg.Pipe(b);
  return ydn.msg.main_;
};
goog.DEBUG && (ydn.msg.Pipe.prototype.toString = function() {
  return "Pipe:" + this.name;
});
ydn.msg.Pipe.dry_run_ = !1;
ydn.msg.Pipe.dryRun = function() {
  ydn.msg.Pipe.dry_run_ = !0;
};
ydn.msg.ChannelName = {DEV:"dev", CONTENT_SCRIPT:"content-script", HOST_PERMISSION:"hostper", POPUP:"popup", OPTIONS:"options", SETUP:"setup"};
ydn.msg.Group = {MAIN:"default", DEV:ydn.msg.ChannelName.DEV, CONTENT_SCRIPT:ydn.msg.ChannelName.CONTENT_SCRIPT, HOST_PERMISSION:ydn.msg.ChannelName.HOST_PERMISSION, POPUP:ydn.msg.ChannelName.POPUP, OPTIONS:ydn.msg.ChannelName.OPTIONS, SUGAR:"sugarcrm"};
ydn.msg.Channels = [ydn.msg.ChannelName.DEV, ydn.msg.ChannelName.CONTENT_SCRIPT, ydn.msg.ChannelName.HOST_PERMISSION, ydn.msg.ChannelName.POPUP, ydn.msg.ChannelName.OPTIONS, ydn.msg.ChannelName.SETUP];
ydn.msg.getChannel = function(a, b) {
  return ydn.msg.getMain().getChannel(a, b);
};
...
goog.exportProperty(ydn.msg.Pipe.prototype, "listen", ydn.msg.Pipe.prototype.listen);
goog.exportProperty(ydn.msg.Pipe.prototype, "getChannel", ydn.msg.Pipe.prototype.getChannel);
goog.exportProperty(ydn.msg.Channel.prototype, "send", ydn.msg.Channel.prototype.send);
...
goog.exportProperty(ydn.async.Deferred.prototype, "addProgback", ydn.async.Deferred.prototype.addProgback);
})();
