...
ydn.crm = {};
ydn.crm.ch = {};
ydn.crm.ch.Req = {APP_SETTING:"app-setting", ACK:"ack", BADGE_UPDATE:"badge-update", CLOSE:"close", DNT_ADD:"dnt-add", DNT_QUERY:"dnt-query", DNT_REMOVE:"dnt-remove", EXPORT_RECORD:"export-record", ECHO:"echo", FEED_LOG:"feed-log", FEED_LOG_INFO:"feed-log-info", FEEDBACK:"feedback", GAPPS_LIST_CAL:"ga-lc", GAPPS_NEW_CAL:"ga-nc", GET_SUGAR:"get-sugar", GDATA_CONTACT_MERGE:"gdata-cm", GDATA_COUNT:"gdata-dc", GDATA_LIST_CONTACT:"gdata-list-contact", GDATA_UPDATE:"gdata-update", LIST_SUGAR:"list-sugarcrm", 
LIST_SUGAR_DOMAIN:"list-sugarcrm-domain", LOG:"log", LOGGING_PREF_ANALYTIC:"lg-pref-qa", LOGGING_PREF_DEBUG:"lg-pref-bg", LOGIN_INFO:"login-info", LOGGED_IN:"logged-in", LOGGED_OUT:"logged-out", LOGIN_SUGAR:"login-su", NEW_ENTRY:"new-entry", NEW_SUGAR:"new-sugarcrm", NUKE:"nk", REMOVE_SUGAR:"remove-sugar", REQUEST:"request", REQUEST_HOST_PERMISSION:"request-host-permission", SERVER_AUDIT_LOG:"server-audit-log", SOCIAL_FEED:"social-feed", SOCIAL_PROFILE:"social-profile", SOCIAL_PROFILE_DETAIL:"social-profile-detail", 
SUGAR_SERVER_INFO:"sugar-server-info", SYNC:"sync", SYNC_FOR:"sync-for", SYNC_GET_LAST:"sync-gl", SYNC_QUERY:"sync-q", TOKEN_GDATA:"token-gdata", TOKEN_REVOKE_GDATA:"token-revoke-gdata", TRACKING_CLEAR_DNT:"tracking-clear-dnt", TRACKING_SELF_OPEN:"tracking-self-open", TRACKING_QUERY:"tracking-query", TRACKING_UPDATE:"tracking-update", USER_LICENSE:"user-license", USER_SETTING_SERVER_GET:"us-server-get", USER_SETTING_SERVER_SET:"us-server-set"};
ydn.crm.ch.BReq = {HOST_PERMISSION:"host-permission", SUGARCRM:"sugarcrm", LOGGED_OUT:"logout", LOGGED_IN:"login", NEW_TRACKING_POINT:"new-tracing-point"};
ydn.crm.ch.SReq = {ABOUT:"about", ACTIVITY_STREAM:"activity-stream", ACTIVITY_UPCOMING:"activity-upcoming", CLEAR_CACHE:"clear-cache", COUNT:"count", DELETE_RECORD:"delete-record", DETAILS:"details", FETCH:"fetch", FETCH_MODULE:"fetch-module", FETCH_UPCOMING_ACTIVITIES:"fetch-up-act", FIND:"find", GET:"get", IMPORT_GDATA:"import-gdata", INFO_MODULE:"info-module", KEYS:"keys", LINK:"link", LIST_MODULE:"list-module", LIST_NAME:"list-name", LOGIN:"login", LOGIN_USER:"login-user", LOGIN_INFO:"login-info", 
NEW_RECORD:"new-record", PUT_RECORD:"put-record", QUERY:"query", QUERY_BY_EMAIL_ON_SERVER:"query-by-email-on-server", QUERY_EMBEDDED:"query-embedded", QUERY_ENTRY:"query-entry", QUERY_RELATED_ASYNC:"query-related-async", QUERY_RELATED:"query-related", QUERY_SIMILAR:"query-similar", REST:"rest", SEARCH:"search", SEARCH_BY_MODULE:"se-bm", SERVER_INFO:"server-info", SET_REL:"set-rel", STATS:"stats", UNLINK:"unlink", UPLOAD:"upload", UPDATE_NOW:"update-now", VALUES:"values"};
