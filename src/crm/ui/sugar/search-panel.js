...
goog.provide('ydn.crm.ui.sugar.SearchPanel');
...
ydn.crm.ui.sugar.SearchPanel = function(dom, model) {
  ...
  this.toolbar = null;
  /**
   * @type {Array.<ydn.crm.ui.sugar.SearchPanel.SearchTask>}
   * @private
   */
  this.search_tasks_ = [];
  /**
...
goog.inherits(ydn.crm.ui.sugar.SearchPanel, goog.ui.Component);


/**
 * @define {boolean} debug flag.
 */
ydn.crm.ui.sugar.SearchPanel.DEBUG = false;
 ...
 * @override
 */
ydn.crm.ui.sugar.SearchPanel.prototype.getModel;


/**
 * @inheritDoc
 */
ydn.crm.ui.sugar.SearchPanel.prototype.createDom = function() {
 ...
 * @private
 */
ydn.crm.ui.sugar.SearchPanel.prototype.clearResult_ = function() {
 ...
 * }}
 */
ydn.crm.ui.sugar.SearchPanel.SearchTask;
 ...
 * @type {number}
 */
ydn.crm.ui.sugar.SearchPanel.MAX_PANELS = 30;
 ...
 * @private
 */
ydn.crm.ui.sugar.SearchPanel.prototype.addResult_ = function(result) {
  ...
  if (n > ydn.crm.ui.sugar.SearchPanel.MAX_PANELS) {
    ...
    m.setResult(result);
    var ch = new ydn.crm.ui.sugar.SearchResult(this.dom_, m);
 ...
 * @private
 */
ydn.crm.ui.sugar.SearchPanel.prototype.computeBackground_ = function(x) {
  var dx = x + 0.1;
  var s = [];
 ...
 * @private
 */
ydn.crm.ui.sugar.SearchPanel.prototype.showStartProgress_ = function(pending_count) {
  ...
  input.style.background = this.computeBackground_(progress);
};
 ...
 * @private
 */
ydn.crm.ui.sugar.SearchPanel.prototype.updateSearch_ = function() {
 ...
 */
ydn.crm.ui.sugar.SearchPanel.prototype.getSearchInput = function() {
 ...
 * @inheritDoc
 */
ydn.crm.ui.sugar.SearchPanel.prototype.getContentElement = function() {
